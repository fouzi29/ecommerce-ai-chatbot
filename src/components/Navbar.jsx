...
export function Navbar({
  ...
  return (
    <header className="sticky top-0 z-40 bg-slate-950/85 backdrop-blur-xl border-b border-purple-500/20 shadow-lg shadow-purple-950/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-extrabold px-2 py-0.5 rounded-full bg-gradient-to-r from-purple-600/20 to-cyan-600/20 text-purple-300 border border-purple-500/30">
                AI STORE
              </span>
            </div>
        ...
        <div className="flex-1 max-w-md hidden md:block">
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-slate-900/90 border border-slate-800 focus:border-purple-500/60 rounded-xl pl-10 pr-4 py-2 text-sm text-slate-100 placeholder-slate-500 outline-none transition-all shadow-inner"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-2.5">
          ...
          <button
            onClick={onOpenGuide}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-cyan-600/20 hover:bg-cyan-600 border border-cyan-500/30 text-xs font-bold text-cyan-300 hover:text-white transition-all shadow-md"
